        ...
        <div className="container relative z-10 text-center px-4">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button asChild size="cta" className="font-heading font-semibold bg-primary hover:bg-primary/90 text-white hover:scale-105 transition-all duration-300">
                <a href="#contact">Get in Touch 📩</a>
              </Button>
              <Button asChild size="cta" className="font-heading font-semibold bg-klawsome-yellow text-klawsome-navy hover:bg-klawsome-yellow/90 hover:scale-105 transition-all duration-300">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="text-left">
              ...
              <div className="text-center mt-7">
                <Button type="submit" size="cta" className="font-heading font-semibold bg-klawsome-yellow text-klawsome-navy hover:bg-klawsome-yellow/90 hover:scale-105 transition-all duration-300">
                  Send Message →
                </Button>
