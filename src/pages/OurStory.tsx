    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[70vh] flex items-end overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 pb-20 pt-32">
          <p className="text-xs font-heading font-bold text-primary uppercase tracking-[0.2em] mb-6 text-white/80">About Us</p>
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-heading font-bold uppercase leading-[0.95] text-white max-w-4xl">
            {title}
          </h1>
        </div>
      </section>
      ...
      <section className="py-28 px-6 lg:px-12">
        <div className="container mx-auto max-w-3xl">
          <p className="text-2xl md:text-3xl font-body leading-relaxed text-foreground">
            {body}
          </p>
        </div>
      </section>
      ...
      {/* Where it all began */}
      <section className="py-28 px-6 lg:px-12 bg-secondary/40">
        <div className="container mx-auto max-w-3xl">
          <p className="text-xs font-heading font-bold text-primary uppercase tracking-[0.2em] mb-4">Origin</p>
          <h2 className="text-4xl md:text-5xl font-heading font-bold uppercase mb-10 leading-[1]">Where it all began.</h2>
      ...
      <section className="py-28 px-6 lg:px-12">
        <div className="container mx-auto max-w-3xl">
          <p className="text-xs font-heading font-bold text-primary uppercase tracking-[0.2em] mb-4">Family & Culture</p>
          <h2 className="text-4xl md:text-5xl font-heading font-bold uppercase mb-10 leading-[1]">Bringing our family into the brand.</h2>
          <div className="space-y-6 font-body text-lg leading-relaxed text-muted-foreground">
