      ...
      <div className="fixed bottom-4 right-4 z-50 flex items-end gap-2 pointer-events-none max-w-[80vw] sm:max-w-none">
        {bubbleVisible && (
          <motion.button
            ...
            className="pointer-events-auto relative bg-white border-2 border-klawsome-navy rounded-2xl px-4 py-3 sm:px-7 sm:py-4 shadow-lg hover:scale-105 transition-transform font-bold text-base sm:text-2xl leading-tight text-center ds-stroke ds-stroke--h3 ds-stroke--navy"
