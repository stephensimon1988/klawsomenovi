          ...
          <div ref={textRef} style={{ opacity: 0 }}>
            ...
            <div className="mb-10 max-w-lg flex items-start gap-4 rounded-xl bg-background/70 p-4 shadow-sm">
              ...
              <div className="min-w-0">
                ...
                {settings?.announcement_enabled && (settings?.announcement_title || settings?.announcement_body) && (
                  <p className="text-sm font-heading font-bold text-primary mt-2">
                    {settings?.announcement_title}
                    {settings?.announcement_title && settings?.announcement_body ? ' — ' : ''}
